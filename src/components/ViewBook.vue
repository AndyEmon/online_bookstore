...
function buy(book){
    book.quantityn = quantity.value
    cardStore.updateCart(book)
}
</script>
            ...
            <v-col md="6">
                <v-card height="620" color="primary">
                    <v-card-Item>
                        ...
                        <v-chip class = "mb-4">{{ book.genre }}</v-chip>
                            <v-row>
                                ...
                                <v-col>
                                    <v-btn color = "lime-ligten" variant = "outlined" density = "compact" readonly> In Stock</v-btn>
                                </v-col>
                            </v-row>
                    ...
                    <v-card-actions>
                        ...
                        <v-btn elevation = "4" variant = "elavated" @click = "buy(book)">Add to cart</v-btn>
                    </v-card-actions>
