...
function view(book){
    booksStore.updateSelectedBooks(book)
        ...
        <v-row>
            <v-col v-for="book in books">
                <v-card class = "h-100 d-flex flex-column">
                    ...
                    <v-card-actions>
                        <v-btn  color="primary" variant = "elavated" @click = "buy(book)">Add to Cart</v-btn>
                        <v-btn  color="primary"variant = "elavated">View Book</v-btn>
                    </v-card-actions>
                </v-card>
            </v-col>
        </v-row>
